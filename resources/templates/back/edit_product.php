...
if (isset($_GET['id'])){
	...
	while($row = fetch_array($query)){
		...
		$product_subcat_id 	 = escape_string($row['product_subcat_id']);
...
<div class="form-group">
    ...
    <div class="form-group row">
	  ...
	  <div class="form-group">
          <label for="short-description">Product Short Desccription</label>
...
<aside id="admin_sidebar" class="col-md-4">
    ...
    <div class="form-group">
         ...
         <select name="product_category_id" id="" class="form-control">
            <option value=""><?php echo show_category_title($product_category_id); ?></option>
           <?php display_categories(); ?>
        </select>
	</div>
	<div class="form-group">
         <label for="product-title">Product Subcategory</label>
         <select name="product_subcat_id" id="" class="form-control">
            <option value=""><?php echo show_subcategory_title($product_subcat_id); ?></option>
           <?php display_subcategories_in_add_page(); ?>
        </select>
	</div>
    <!-- Product Brands-->
